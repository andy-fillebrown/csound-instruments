<Cabbage>
form size(1100, 850), caption("Akai MIDIMix"), pluginID("akaimm00")
...
groupbox bounds(0, 0, 1100, 850), plant("Akai MIDIMix 00") {
    ...
    ; MIDI In Button
    checkbox bounds(0.013636364, 0.017647059, 0.090909091, 0.011764706), channel("read_midi"), value(1), text("MIDI In"), fontcolour("black")
	...
	vslider  bounds(0.102727273, 0.688235294, 0.074545455, 0.258823529), channel("akai_midimix__slider_1"),  range(0, 127, 0, 1, 1)
	...
	vslider  bounds(0.194545455, 0.688235294, 0.074545455, 0.258823529), channel("akai_midimix__slider_2"),  range(0, 127, 0, 1, 1)
	...
	vslider  bounds(0.284545455, 0.688235294, 0.074545455, 0.258823529), channel("akai_midimix__slider_3"),  range(0, 127, 0, 1, 1)
	...
	vslider  bounds(0.373636364, 0.688235294, 0.074545455, 0.258823529), channel("akai_midimix__slider_4"),  range(0, 127, 0, 1, 1)
	...
	vslider  bounds(0.462727273, 0.688235294, 0.074545455, 0.258823529), channel("akai_midimix__slider_5"),  range(0, 127, 0, 1, 1)
	...
	vslider  bounds(0.552727273, 0.688235294, 0.074545455, 0.258823529), channel("akai_midimix__slider_6"),  range(0, 127, 0, 1, 1)
	...
	vslider  bounds(0.642727273, 0.688235294, 0.074545455, 0.258823529), channel("akai_midimix__slider_7"),  range(0, 127, 0, 1, 1)
	...
	vslider  bounds(0.732727273, 0.688235294, 0.074545455, 0.258823529), channel("akai_midimix__slider_8"),  range(0, 127, 0, 1, 1)
	
	; Master
	vslider  bounds(0.820909091, 0.688235294, 0.074545455, 0.258823529), channel("akai_midimix__slider_9"),  range(0, 127, 0, 1, 1)
}
...
instr 1
	...
	i_volume_envelope_release_time = 10 ; chnget "volume_envelope_release_time"
